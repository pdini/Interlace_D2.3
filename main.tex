...
\input{2-Final_Architecture/finarch}
\chapter*{References}
...
\addcontentsline{toc}{chapter}{Appendix: Additional Functional Requirements and Business Logic Model (2018)}
...
\input{3-Appendix/SardexNewPaymentSpec_AddOns}
